...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "research",
          description: "Here is a list of research projects I have worked on or am currently working on.",
          section: "Navigation",
          handler: () => {
          ...
          title: '2d materials and interfaces',
          description: "",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/LouieSlocombe", "_blank");
        },
      },{
        id: 'social-gitlab',
        title: 'GitLab',
        section: 'Socials',
        handler: () => {
          window.open("https://gitlab.com/LouieSlocombe", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-6986-5526", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=JISRQewAAAAJ", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
